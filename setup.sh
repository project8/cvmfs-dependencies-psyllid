...
#export P8DEPPSYLLIDBUILD=build-2018-04-23

# source the common dependencies 
source /cvmfs/hep.pnnl.gov/project8/dependencies-common/${P8DEPBUILD}/setup.sh

export P8DEPPSYLLIDBASEDIR=${P8BASEDIR}/dependencies-psyllid/${P8DEPKATYDIDBUILD}
...
export PYTHONPATH=${P8DEPPSYLLIDBASEDIR}/lib/root:${P8DEPKATYDIDBASEDIR}/lib:${P8DEPKATYDIDBASEDIR}:${PYTHONPATH}
